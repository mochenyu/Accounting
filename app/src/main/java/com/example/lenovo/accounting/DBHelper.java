...
import android.database.sqlite.SQLiteOpenHelper;
    ...
    public class DBHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {//创建数据库所执行的操作
            db.execSQL("CREATE TABLE "+TB_NAME1+"(ID INTEGER PRIMARY KEY AUTOINCREMENT,CURMARK TEXT,CUREX TEXT,CURDATE TEXT)");
            db.execSQL("CREATE TABLE "+TB_NAME2+"(ID INTEGER PRIMARY KEY AUTOINCREMENT,CURMARK TEXT,CURIN TEXT,CURDATE TEXT)");
        }
